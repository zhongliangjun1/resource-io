...
public class AutoPopulatingList<E> implements List<E>, Serializable {
	...
	/**
	 * The {@link com.dianping.resource.io.util.AutoPopulatingList.ElementFactory} to use to create new {@link java.util.List} elements
	 * on demand.
	 */
	...
	/**
	 * Creates a new {@code AutoPopulatingList} that is backed by a standard
	 * {@link java.util.ArrayList} and creates new elements on demand using the supplied {@link com.dianping.resource.io.util.AutoPopulatingList.ElementFactory}.
	 */
	...
	/**
	 * Creates a new {@code AutoPopulatingList} that is backed by the supplied {@link java.util.List}
	 * and creates new elements on demand using the supplied {@link com.dianping.resource.io.util.AutoPopulatingList.ElementFactory}.
	 */
	...
	public interface ElementFactory<E> {
		 ...
		 * @throws com.dianping.resource.io.util.AutoPopulatingList.ElementInstantiationException if the instantiation process failed
