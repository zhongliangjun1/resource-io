...
package com.dianping.resource.io.util;
...
/**
 * A {@link java.util.concurrent.ConcurrentHashMap} that uses {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.ReferenceType#SOFT soft} or
 * {@linkplain com.dianping.resource.io.util.ConcurrentReferenceHashMap.ReferenceType#WEAK weak} references for both {@code keys} and {@code values}.
 *
...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
	...
	/**
	 * Factory method that returns the {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.ReferenceManager}.
	 * This method will be called once for each {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Segment}.
	...
	/**
	 * Returns a {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Reference} to the {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Entry} for the specified {@code key} or
	...
	/**
	 * A reference to an {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Entry} contained in the map. Implementations are usually
	...
	/**
	 * A task that can be {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Segment#doTask run} against a {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Segment}.
	 */
	private abstract class Task<T> {
		 ...
		 * @see #execute(com.dianping.resource.io.util.ConcurrentReferenceHashMap.Reference, com.dianping.resource.io.util.ConcurrentReferenceHashMap.Entry)
		 */
		...
		/**
		 * Convenience method that can be used for tasks that do not need access to {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Entries}.
		 * @param reference the found reference or {@code null}
		 * @param entry the found entry or {@code null}
		 * @return the result of the task
		 * @see #execute(com.dianping.resource.io.util.ConcurrentReferenceHashMap.Reference, com.dianping.resource.io.util.ConcurrentReferenceHashMap.Entry, com.dianping.resource.io.util.ConcurrentReferenceHashMap.Entries)
		 */
	...
	/**
	 * Allows a task access to {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Segment} entries.
	 */
	...
	/**
	 * Strategy class used to manage {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Reference}s. This class can be overridden if
	...
	protected class ReferenceManager {
		...
		/**
		 * Factory method used to create a new {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Reference}.
		 * @param entry the entry contained in the reference
		 * @param hash the hash
		 * @param next the next reference in the chain or {@code null}
		 * @return a new {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Reference}
		 */
	...
	/**
	 * Internal {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Reference} implementation for {@link java.lang.ref.SoftReference}s.
	 */
	...
	/**
	 * Internal {@link com.dianping.resource.io.util.ConcurrentReferenceHashMap.Reference} implementation for {@link java.lang.ref.WeakReference}s.
	 */
